...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setAuth(data.token, { name: data.name, email: data.email, provider: "LOCAL" });
      navigate("/dashboard");
    } catch {
      ...
      <div style={{ width: "100%", maxWidth: 420, position: "relative" }} className="fade-in">
        ...
        <div style={{ textAlign: "center", marginBottom: 36 }}>
          ...
          <p style={{ color: "var(--text-secondary)", fontSize: 13 }}>
            Sign in to your DevForge AI workspace
          </p>
        </div>
        ...
        <div className="card" style={{ padding: 28 }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <button
              ...
              disabled={loading}
              style={{ width: "100%", justifyContent: "center", padding: "10px 16px", fontSize: 14, marginTop: 2, opacity: loading ? 0.7 : 1 }}
            >
              {loading
